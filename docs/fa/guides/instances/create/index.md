...
در گام اول شما باید یک نام برای سرور ابری خود انتخاب نمایید.
...
::: info توصیه:
پیشنهاد میکنیم قبل از ساخت سرور ابری حداقل به اندازه ۲۴ ساعت در حساب کاربری خود شارژ داشته باشید.
:::
